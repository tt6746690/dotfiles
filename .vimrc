...
" keep cursor centored while scrolling
set scrolloff=999
...
" quick adjust window size 
" Ctrl+W = resize window to equal width
...
set ignorecase
" /LINUX will search for LINUX only whereas /linux search ignore case
set smartcase           
set incsearch
